...
class Branchvendormanagement extends React.Component{
...
{ data.branches.map((branches, length) => { return(
        <div 
          ...
          ><Link to={"Branchvendirdetailsmain/"+length+"/"+length1} style={{textDecoration: 'none'}} >
            <div className="row">
              {" "}
              <img
          ...
          <div
            className="col border border-white" style={{margin: "25px"}}
            
          ><Link to={"Addbranchvendor/"+data.id} style={{textDecoration: 'none'}} >
            <div className="row">
              {" "}
              <img
           style={{height: "60px" , width: "70px",  marginLeft: "90px", marginTop: "60px", borderRadius: 20, marginTop: 5, }}
                src="assets/images/addbranchvendor2.png"
                alt
              />
            </div>
            <p
              className="h4"
              style={{ marginTop: 20, marginLeft: 60, color: "rgb(0, 0, 0)" }}
            >
              <b>Add New Branch</b>
            </p>
            </Link>
...
export default Branchvendormanagement
...
class Recipemanagementcat extends React.Component{

  state = { data: [],data2: [], idd: ''};
...
const reqTwo = axios.get(url,{headers});
console.log(url)
...
axios.all([reqOne, reqTwo]).then(axios.spread((...responses) => {
  ...
  // react on errors.
    ...
    render(){
      ...
      const idforrecipie= this.props.match.params.id;
          ...
          <div id="page-content-wrapper">
            <div className="container">
              ...
              <div class="col" ><  img src="/assets/images/back_button.png" style={{width: '35px', marginTop: '-5px', marginLeft: '-5px'}} onClick={this.props.history.goBack} /></div>
                ...
                <div class="col">
               <a href={"/Createrecipie/"+idforrecipie}> <button
                type="button"
...
{ data.map((data, length) => { 
  ...
  return( 
                    <tr>
                      ...
                      <td>{data.name}</td>
                      <td id="vde"><span style={{float: 'right'}}><a href={"/Viewrecipie/"+this.state.idd+"/"+length} style={{textDecoration: 'none'}}>View Details <img src="assets/images/arrow-view-details.png" alt="" /></a></span></td>
    ...
    export default Recipemanagementcat

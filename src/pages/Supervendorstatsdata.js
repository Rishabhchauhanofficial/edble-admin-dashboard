...
class Supervendorstatsdata extends React.Component{
  ...
  componentDidMount(){
    ...
    axios.post("http://3.14.168.174/order/getAllStaticsBySuperMarket/"+this.props.match.params.id,formData,config)
    .then((resp)=>{
...
export default Supervendorstatsdata;
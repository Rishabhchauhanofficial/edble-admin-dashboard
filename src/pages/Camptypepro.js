...
import offersdi from './offersdi';
import axios from 'axios';
class Camptypepro extends React.Component{
  constructor(props){
    super(props);
    this.state={
      branchid: "",
...
componentDidMount(){
  ...
  axios.get('http://3.14.168.174/getItemByBranch/'+branchid,{headers})
  .then((resp)=>{
console.log(resp)
    ...
    render(){
        ...
        <div id="wrapper">
          ...
          <div class="container">
            ...
            <div className="row">
              <div className="col" style={{fontSize: '20px', boxShadow: '3px 2px 10px rgba(175, 175, 175, 0.685)', marginRight: '10px', height: '120px', background: 'linear-gradient(0deg, rgba(255,51,0,0.9416141456582633) 0%, rgba(255,77,77,1) 100%)', borderRadius: '5px', alignItems: 'center'}}> <b className="com" style={{marginTop: "45px", marginLeft: "160px"}}><Link to={"/Camptypepro/"+this.state.branchid} style={{textDecoration: "none", color: "white" }} >Campaign On Product</Link></b></div>
              <div className="col" style={{fontSize: '20px', boxShadow: '3px 2px 10px rgba(175, 175, 175, 0.685)', marginRight: '10px', height: '120px', background: 'white', borderRadius: '5px', alignItems: 'center'}}> <b className="com" style={{marginTop: "45px", marginLeft: "160px"}}><Link to={"/Camptypecate/"+this.state.branchid} style={{textDecoration: "none", color: "red" }}>Campaign On Categories</Link></b></div>
            </div>
  ...
  <div class= "container">
    ...
    state: {
      usersdata: this.state.seleteditems
        ...
        <offersdi selecteditems={this.state.seleteditems}/>

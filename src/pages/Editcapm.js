...
class Editcapm extends React.Component{
constructor(props){
  super(props);
  this.state={
    branchid: "",
...
editcamp=(e)=>{
  ...
  height: "40px",}}/>
              ...
              <div class="row" style={{width: '400px',marginLeft: '45px'}}>
  ...
  <div class="col" style={{
    ...
    <div class="col">
      <input type="number" style={{fontSize: "25px"}} class="form-control" value={this.state.buy}  onChange={this.handlebuy}/>
    </div><div class="col" style={{
          fontSize: "25px"
        }}><b>Get</b></div>
    <div class="col">
      <input type="number" style={{fontSize: "25px"}} class="form-control" value={this.state.free} onChange={this.handlefree} placeholder="1" />
    </div>
    <div class="col" style={{
          fontSize: "25px"
        }}><b>Free...</b></div>

...
class Foodongoingorder extends React.Component{
  constructor(props){
    super(props)
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="row" style={{fontSize: "15px"}}>
      ...
      <div class="col"><b>Delivered By:</b> {this.state.deliveredby}</div>
            ...
            <div className="row">
              ...
              <div className="col" style={{fontSize: '20px', boxShadow: '3px 2px 10px rgba(175, 175, 175, 0.685)', marginRight: '10px', height: '70px', borderRadius: '5px',background: 'linear-gradient(0deg, rgba(255,51,0,0.9416141456582633) 0%, rgba(255,77,77,1) 100%)'}}><b className="inc" > <Link  to={"/Foodongoingorder/"+this.state.empid+"/"+this.state.branchid+"/"+this.state.fname+"/"+this.state.lname+"/"+this.state.emailaddress+"/"+this.state.phoneno} style={{textDecoration: "none", color: "white"}}>Ongoing Order</Link></b></div>
    ...
    export default Foodongoingorder

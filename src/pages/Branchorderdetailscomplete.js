...
class Branchorderdetailscomplete extends React.Component{
  constructor(props){
    super(props)
...
axios
.get("http://3.14.168.174/order/getOrdersByBranch/"+id+"/completed-order",{headers})
.then((resp)=>{
    ...
    <div class="row" style={{fontSize: "15px"}}>
      ...
      <div class="col"><b>Delivered By:</b> {this.state.deliveredby}</div>
            ...
            <div className="row">
              ...
              <div className="col" style={{fontSize: '20px', boxShadow: '3px 2px 10px rgba(175, 175, 175, 0.685)', marginRight: '10px', height: '70px',background: 'linear-gradient(0deg, rgba(255,51,0,0.9416141456582633) 0%, rgba(255,77,77,1) 100%)', borderRadius: '5px'}}><b className="inc"><a href={"/Branchorderdetailscomplete/"+this.state.branchid} style={{textDecoration: "none", color: "white"}}> Complete Order</a></b></div>
            </div>
            <br /><br />
            <div className="row">
              <div className="col">
...
export default Branchorderdetailscomplete
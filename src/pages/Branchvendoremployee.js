...
class Branchvendoremployee extends React.Component{
  constructor(props){
    super(props);
    this.state={
      data: [],
  ...
  componentDidMount(){
    ...
    axios.get('http://3.14.168.174/getEmpOrMan/2/'+id,{headers})
    .then((resp)=>{
    ...
    render(){
        ...
        return(
          ...
          <nav className="navbar navbar-default no-margin">
            <div className="navbar-header fixed-brand">
              <button type="button" className="navbar-toggle collapsed" data-t  oggle="collapse" id="menu-toggle">
        ...
        <div id="wrapper">
          ...
          <div id="page-content-wrapper">
            ...
            <br />
            <div className="row">
              <div className="col" style={{fontSize: '20px', boxShadow: '3px 2px 10px rgba(175, 175, 175, 0.685)', marginRight: '10px', height: '70px', background: 'linear-gradient(0deg, rgba(255,51,0,0.9416141456582633) 0%, rgba(255,77,77,1) 100%)', borderRadius: '5px', alignItems: 'center'}}> <b className="com"><Link to={"/Branchvendoremployee/"+this.state.branchid+"/"+this.state.name+"/"+this.state.address} style={{color: "white", textDecoration: "none", textAlign: "center"}}>Employee</Link></b></div>
              <div className="col" style={{fontSize: '20px', boxShadow: '3px 2px 10px rgba(175, 175, 175, 0.685)', marginRight: '10px', height: '70px', borderRadius: '5px'}}><b className="inc"><Link to={"/Branchvendormanager/"+this.state.branchid+"/"+this.state.name+"/"+this.state.address} style={{color: "red", textDecoration: "none", textAlign: "center"}}> Manager</Link></b></div>
            </div>
            <br /><br />
...
return(
  <tr>
      <th scope="row"><a href="/Employeeditprofile"><img src="/assets/images/editicon.png"/></a></th>
      <td>{data.email}</td>
      <td>*******</td>
...
export default Branchvendoremployee
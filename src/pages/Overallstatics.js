...
class Overallstatics extends React.Component{
  constructor(props){
    super(props)
  ...
  componentDidMount(){
    ...
    axios.post("http://3.14.168.174/order/getAllStatics",formData,config)
    .then((resp)=>{
...
<button style={{borderRadius: '25px', backgroundColor: 'red', marginTop: '10px', width: '250px', fontSize: '25px'}}  className="btn btn-danger" onClick={()=>{this.handleModal2()}} >Submit</button>
        ...
        <div id="wrapper">
          ...
          <div class="container">
            ...
            <div className="container">
            <div className="row">
              <div className="col" style={{fontSize: '20px', boxShadow: '3px 2px 10px rgba(175, 175, 175, 0.685)', marginRight: '10px', height: '120px', background: 'white', borderRadius: '5px', alignItems: 'center'}}> <b className="com" style={{marginTop: "45px", marginLeft: "100px"}}><Link to="Overallstatics" style={{textDecoration: "none", color: "red" }} >Overall Statics</Link></b></div>
              ...
              <hr/>
              <div className="col" style={{fontSize: '20px', boxShadow: '3px 2px 10px rgba(175, 175, 175, 0.685)', marginRight: '10px', height: '120px', background: 'linear-gradient(0deg, rgba(255,51,0,0.9416141456582633) 0%, rgba(255,77,77,1) 100%)', borderRadius: '5px', alignItems: 'center'}} > <b className="com" style={{marginTop: "45px", marginLeft: "100px", textAlign: "center"}}><Link to="" style={{textDecoration: "none", color: "white " }}>Total No. of Order Delivered<br/>{this.state.totalOrders}</Link></b></div>
              <div className="col" style={{fontSize: '20px', boxShadow: '3px 2px 10px rgba(175, 175, 175, 0.685)', marginRight: '10px', height: '120px', background: 'linear-gradient(0deg, rgba(255,51,0,0.9416141456582633) 0%, rgba(255,77,77,1) 100%)', borderRadius: '5px', alignItems: 'center'}}> <b className="com" style={{marginTop: "45px", marginLeft: "150px", textAlign: "center"}}><Link to="" style={{textDecoration: "none", color: "white" }}>Total Amount Earned <br/><img src="assets/images/euro.png"  style={{width: "20px"}}/> {this.state.toTalearning}</Link></b></div>

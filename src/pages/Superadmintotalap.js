...
class Superadmintotalap extends React.Component{
  ...
  componentDidMount() {
          ...
          <div class="container">
            ...
            <div class="container">
                ...
                <div class="row">
                 ...
                 <div class="col border  border-danger border-4" style={{backgroundColor: 'rgb(255, 219, 219)', borderRadius: '10px' ,margin: "30px" ,width: "50px", height: "200px" }}><Link to="Superadmintotalap" style={{textDecoration: "none"}}><>
                    <div class="row" style={{ boxShadow: '2px 2px 4px #0000004f', height: '50px', marginLeft: '10px', marginTop: '10px', borderRadius: '20px',  background: 'rgb(255,51,0)', background: 'linear-gradient(0deg, rgba(255,51,0,0.9416141456582633) 0%, rgba(255,77,77,1) 100%)', width: '60px' }} > <img  src="assets/images/Total Order.png" alt="" style={{height: '40px', marginTop: '3px', marginLeft: '1px'}}/></div>
    ...
    export default Superadmintotalap